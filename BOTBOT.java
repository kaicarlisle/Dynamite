...
public class BOTBOT implements Bot {
	...
	// TODO
	// get weightings for more than just the previous one move at each step
	// currently n-1 => n
	// maybe n-2 => n-1 => n

	// test each prediction on previous moves as though it were on that turn?
	// to work out which is the best possible guess
